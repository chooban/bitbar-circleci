    ...
    for project in projects:
        ...
        for running_build in running_builds:
            ...
            if 'not_running' is not status:
                ...
                output_msg = u'- {} {}'.format(symbol, urllib.parse.unquote(running_build['branch_name']))
                output.append(u'{} | {} {}'.format(output_msg, branch_href, color))


        for recent_build in sorted(recent_builds, key=lambda x: x['outcome']):
            ...
            if not outcome in ['no_tests']:
                ...
                output_msg = u'- {} {}'.format(symbol, urllib.parse.unquote(recent_build['branch_name']))
                output.append(u'{} | {} {}'.format(output_msg, branch_href, color))
